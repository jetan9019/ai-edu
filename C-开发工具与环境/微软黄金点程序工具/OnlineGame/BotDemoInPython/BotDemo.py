...
def perProcess(roomid, userid, usertoken):
  ...
  if usertoken is None and os.path.isfile(tokenFile):
...
if __name__ == '__main__':
  ...
  parser.add_argument('--userid', type=int, help='User ID', required=False)
  parser.add_argument('--token', type=int, help='User token', required=False)
